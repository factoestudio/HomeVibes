...
const leads = [
  ...
  // =========================================================================
  {
    contact_name: "Sales & Marketing Team",
  ...
  {
    contact_name: "Michael & Sara Camber",
  ...
  {
    contact_name: "Heaps Estrin Team",
    company_name: "Cailey Heaps (Heaps Estrin Real Estate)",
    category: "Realtor / Brokerage",
    target_region: "Yonge & Eglinton, Rosedale, Leaside",
    email: "team@heapsestrin.com",
    phone: "416-424-4910",
  ...
  // =========================================================================
  // 5. ADDITIONAL REGIONAL REALTORS, BUILDERS & LIFESTYLE SERVICES (GTA)
  // =========================================================================
  {
    ...
    website: "https://heapsestrin.com",
    recommended_sponsorship_tier: "Exclusive Area Sponsor ($750–$1,500/mo)",
    pitch_angle: "Toronto's #1 luxury team for Midtown and central high-net-worth neighborhoods."
  },
  {
...
console.log(`✅ Successfully exported ${leads.length} verified advertiser leads to JSON: ${jsonPath}`);
...
console.log(`✅ Successfully exported ${leads.length} verified advertiser leads to CSV: ${csvPath}`);
